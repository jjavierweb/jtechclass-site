...
<svelte:head>
	<title>Homepage - Javier Aviation</title>
	<meta
		name="description"
		content="Javier Aviation is a IT consulting company that speciallices on helping small business fill their IT needs to attract customers"
	/>
</svelte:head>
<div>
