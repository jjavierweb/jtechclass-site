<script lang="ts">
	...
	import Mission from '$lib/assets/images/Mission.svg';
	import Vission from '$lib/assets/images/Vission.svg';
</script>
...
<div class="container mx-auto p-4 mt-12">
	<div class="flex flex-col md:grid md:grid-cols-2 md:gap-2">
		...
		<div class="mt-8">
			<h2 class="text-3xl font-semibold md:text-5xl">Our Mission:</h2>
			<p class="text-justify mt-4 text-lg">
				...
				delivering exceptional customer service and building long-term partnerships with our
				clients. By leveraging our expertise and cutting-edge technology, we aim to help small
				businesses succeed in today's rapidly changing business landscape.
			</p>
		</div>
	</div>
	...
	<div class="flex flex-col-reverse md:grid md:grid-cols-2 md:gap-2 mt-12">
		<div class="mt-8">
			...
			<p class="text-justify mt-4 text-lg">
				Javier Aviation is a small business dedicated to helping other small businesses with their
				IT needs. Our vision is to become the go-to IT solutions provider for small businesses in
				our community and beyond. We believe that small businesses are the backbone of the economy,
				and we are passionate about helping them succeed. We understand the unique challenges that
				small businesses face when it comes to IT, and we are committed to providing affordable,
				reliable, and user-friendly solutions that allow them to focus on what they do best: growing
				their business. To achieve this vision, we will strive to consistently deliver excellent
				customer service and technical support to our clients. We will stay up to date with the
				latest technologies and best practices in the industry, and we will always go the extra mile
				to ensure that our clients are satisfied with our services. In the long term, we hope to
				expand our reach and help even more small businesses with their IT needs. We envision a
				future where every small business has access to the resources and support they need to
				thrive, and we are committed to playing a key role in making that a reality.
			</p>
		</div>
		<img
			src={Vission}
			...
			width="0"
			height="0"
			class="w-auto h-96 self-end place-self-end"
		/>
	</div>
</div>
